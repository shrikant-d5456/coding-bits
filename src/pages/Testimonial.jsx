...
const Testimonial = () => {
  ...
  return (
    <div className='w-full h-screen flex flex-col justify-center items-center gap-4 m-auto transition-all duration-200 dark:bg-black dark:text-white '>
      <p className=' text-4xl font-bold text-center'>Our Experts</p>
      <div className=" w-[400px] sm:flex justify-center items-center gap-8 dark:bg-black dark:text-white p-8 ">

        <div className="hover:scale-105  overflow-hidden flex flex-col justify-center items-center mb-8 shadow-2xl shadow-gray-300 dark:shadow-gray-800 rounded-2xl transition-all cursor-pointer">

          <div className=" relative overflow-hidden top-6 gap-2">
            <img src={arr[currentIndex].image || EmptyImg} alt="img"
